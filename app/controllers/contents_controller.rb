class ContentsController < ApplicationController
  ...
  def destroy
    @content.destroy
    respond_to do |format|
      format.html { redirect_to contents_url, notice: 'Il contenuto è stato definitivamente eliminato' }
    end
  end
  ...
  private
    ...
    def content_params
      params.require(:content).permit(:titolo, :descrizione, :price, :cover, :alleato)
    end
